...
codeEditor = "~/.config/hypr/hyprland/scripts/launch_first_available.sh 'zed' 'windsurf' 'antigravity' 'code' 'codium' 'cursor' 'zedit' 'zeditor' 'kate' 'gnome-text-editor' 'emacs' 'command -v nvim && kitty -1 nvim' 'command -v micro && kitty -1 micro'"
